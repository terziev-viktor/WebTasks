[assembly: WebActivatorEx.PreApplicationStartMethod(typeof(WebTasks.App_Start.NinjectWebCommon), "Start")]
[assembly: WebActivatorEx.ApplicationShutdownMethodAttribute(typeof(WebTasks.App_Start.NinjectWebCommon), "Stop")]

namespace WebTasks.App_Start
{
    using System;
    using System.Web;
    ...
    public static class NinjectWebCommon 
    {
        ...
        private static void RegisterServices(IKernel kernel)
        {
            ...
            kernel.Bind<IDailyTasksService>().To<DailyTasksService>();
